...
def get_user(id, userId):
    ...
    top_five_movie = movie_arr.sort_values(by="rating", ascending=False)[:6]
    return top_five_movie['title'].values.tolist()

#가까운 유저
def get_user_item(id):
    best = (user_item_rating[user_item_rating['userId']==id]
